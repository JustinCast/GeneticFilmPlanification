...
namespace GeneticFilmPlanification
{
    class Pmx
    {
        ...
        {// se altera el orden de calendario para crear otro pero en orden distinto
        ...
        {// se realiza el cruce entre los dos calendarios para obtener otro mediante un cruce
